...
public class SearchActivity extends AppCompatActivity {
    ...
    protected void onNewIntent(Intent intent) {
        ...
        if (Intent.ACTION_SEARCH.equals(intent.getAction())) {
            ...
            ArrayList<Margarita> margaritaListByCountry = JSON.getMargaritaListByCountry(margaritaList, query);
    ...
    private class AsyncFetch extends AsyncTask<String, String, ArrayList<Margarita>> {
        ...
        @Override
        protected void onPostExecute(ArrayList<Margarita> coronaList) {
            //this method will be running on UI thread
            pdLoading.dismiss();
